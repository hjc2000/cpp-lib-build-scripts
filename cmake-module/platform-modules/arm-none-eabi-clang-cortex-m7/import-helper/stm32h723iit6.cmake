# region target_import_stm32h723iit6_hal

function(target_import_stm32h723iit6_hal target_name visibility)
	...
	set(lib_name "stm32h723iit6-hal")
...
# region target_import_stm32h723iit6_peripherals

function(target_import_stm32h723iit6_peripherals target_name visibility)
	set(lib_name "stm32h723iit6-peripherals")
	target_include_directories(${target_name} ${visibility} ${libs_path}/${lib_name}/include)
	target_add_source_files_recurse(${target_name} "${libs_path}/${lib_name}/obj/")
endfunction()
