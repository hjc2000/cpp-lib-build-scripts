...
function(target_import_tsduck target_name visibility)
    target_include_directories(${target_name} ${visibility} $ENV{cpp_lib_build_scripts_path}/${platform}/.libs/tsduck/include/)
    target_auto_link_lib(${target_name} tsduck $ENV{cpp_lib_build_scripts_path}/${platform}/.libs/tsduck/lib/)
