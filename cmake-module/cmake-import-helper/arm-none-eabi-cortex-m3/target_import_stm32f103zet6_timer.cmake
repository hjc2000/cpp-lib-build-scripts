...
function(target_import_stm32f103zet6_timer target_name visibility)
    target_include_directories(${target_name} ${visibility} ${libs_path}/stm32f103zet6-timer/include/)
    target_auto_link_lib(${target_name} stm32f103zet6-timer ${libs_path}/stm32f103zet6-timer/lib/)
    install_dll_dir(${libs_path}/stm32f103zet6-timer/bin/)
