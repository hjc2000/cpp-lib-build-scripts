...
function(target_link_so target_name visibility so_name search_path success)
    ...
    if(NOT found_lib STREQUAL "")
        ...
        target_link_libraries(${target_name} ${visibility} ${full_path})
...
function(target_link_static_lib target_name visibility lib_name search_path success)
...
function(target_auto_link_lib target_name visibility lib_name search_path)
    # 尝试链接共享库
    set(success_so)
    target_link_so(${target_name} ${visibility} ${lib_name} ${search_path} success_so)
    if(success_so)
        return()
    endif()
    ...
    # 继续尝试链接静态库
    set(success_static)
    target_link_static_lib(${target_name} ${visibility} ${lib_name} ${search_path} success_static)
    if(success_static)
        return()
    endif()
