...
$source_path = "$repos_path/freertos-heap4-new"
$install_path = "$libs_path/freertos-heap4-new"
...
try
{
	...
	git-get-repo.ps1 -git_url "https://github.com/hjc2000/freertos-heap4-new.git"
