...
$source_path = "$repos_path/stm32h743iit6-ethternet"
$install_path = "$libs_path/stm32h743iit6-ethternet"
...
try
{
	...
	git-get-repo.ps1 -git_url "https://github.com/hjc2000/stm32h743iit6-ethternet.git"
	...
	Install-Dependent-Dlls-From-Dir -dll_dir "$libs_path/task/bin"
