...
try
{
	...
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-sdram"
	Try-Remove-Item.exe --path "$libs_path/lwip-wrapper"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-ethternet"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-isr"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-p-net"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-gpio"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-flash"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-interrupt"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-timer"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-dma"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-serial"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-clock"
	Try-Remove-Item.exe --path "$libs_path/system-call"
	Try-Remove-Item.exe --path "$libs_path/stm32h743iit6-hal"
	Try-Remove-Item.exe --path "$libs_path/lwip"
	Try-Remove-Item.exe --path "$libs_path/freertos-osal"
