...
$source_path = "$repos_path/stm32h743iit6-clock"
$install_path = "$libs_path/stm32h743iit6-clock"
...
try
{
	...
	git-get-repo.ps1 -git_url "https://github.com/hjc2000/stm32h743iit6-clock.git"
