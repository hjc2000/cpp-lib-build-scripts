...
$source_path = "$repos_path/stm32f103zet6-timer"
$install_path = "$libs_path/stm32f103zet6-timer"
...
try
{
	...
	git-get-repo.ps1 -git_url "https://github.com/hjc2000/stm32f103zet6-timer.git"
